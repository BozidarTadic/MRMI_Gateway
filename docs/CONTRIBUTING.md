...
Read the [Architecture Decision Record](ADR_v0.5.md). Every design choice in the codebase traces back to it. If you want to propose something that contradicts an ADR decision, open an issue first — don't send code that will immediately conflict.

## What Needs Work

The [v0.1 milestone tracker](ADR_v0.5.md#12-next-steps--v01-milestones) lists open work. Items explicitly marked as "open for contributors":
